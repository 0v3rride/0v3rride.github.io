...
# How Mistyping A URL Led Me To Obtaining My First CVE ID (2019-6716)
_____________________________________________________________________


### Preface
Obtaining a CVE ID for an undisclosed vulnerability is something that most individuals in the information security field aspire to achieve sometime in their career. Coming across an issue like this due to accidental malformed input on the user's own behalf is far and few between from my understanding. I have to admit that the issue I discovered is not as serious or as impressive as a vulnerability that allows for remote code execution or privilege escalation. However, I did find it interesting due to what this affected web applicatioon was built for and the potential attack vectors that could be leveraged due to it.
